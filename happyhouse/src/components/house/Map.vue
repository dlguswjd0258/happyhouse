...
import aptMarker from '@/assets/aptMarker.png';
export default {
  data() {
    return {
      deals: [],
  ...
  methods: {
    initMap() {
      ...
      // marker1.setMap(map);
      var imageSrc =
          // 'https://img-premium.flaticon.com/png/512/4550/4550968.png?token=exp=1621925513~hmac=0ac36993aa79aec61cd425bf9eb4d49c', // 마커이미지의 주소입니다
          aptMarker, // 마커이미지의 주소입니다
      ...
      map.setCenter(
        new kakao.maps.LatLng((maxlat * 1 + minlat * 1) / 2, (maxlng * 1 + minlng * 1) / 2)
      );
    ...
    addScript() {
      ...
      script.src =
        'http://dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=f98eb0693d6b9ced430bdc334d33e08e&libraries=services';
